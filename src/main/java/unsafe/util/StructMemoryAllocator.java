...
//
//    public static long allocateMemory(Class<? extends Struct> runtimeStruct) {
...
////        }
//
//        // this isn't necessary unless I decide that I want to declare values directly on the NativeAlloc annotation
////        for (Field field : fields) {
////            if (field.isAnnotationPresent(NativeAlloc.class)) {
////                field.setAccessible(true);
////                NativeAlloc nativeAlloc = field.getAnnotation(NativeAlloc.class);
////                getFieldAllocationOperation(field.getType().getSimpleName(), internalMemoryBlock, nativeAlloc.order(), nativeAlloc.size())
////                        .accept(getFieldType(field, runtimeStruct).get());
////            }
////        }
//
...
//    }
//
//    public static void freeMemory(long structHandle) {
//        UnsafeHelper.getUnsafe().freeMemory(structHandle);
//    }
//
